...
/**
 * The reaper (moissonneur) resides in any actor system and terminates it
 * as soon as all watched actors have terminated.
 */
public class Reaper extends AbstractLoggingActor {
	...
	// Asks the Reaper to watch for the termination of the sender.
