...
public class ReactiveSchedulingStrategy implements SchedulingStrategy {
	...
	private class QueryTracker {
		...
		/**
		 * Assign a subquery of the tracked query to the worker.
		 * If a subquery was available, a {@link Worker.ValidationMessage} is send to the worker with master as sender.
		 *
