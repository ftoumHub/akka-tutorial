...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (isNull(jCommander.getParsedCommand())) {
            ...
            out.printf("Could not parse args: %s\n", e.getMessage());
            if (isNull(jCommander.getParsedCommand())) {
                jCommander.usage();
            } else {
    ...
    abstract static class CommandBase {
        ...
        String getDefaultHost() { // Provide the default host.
            try {
        ...
        abstract int getDefaultPort();  // Provide the default host.
    }
}
